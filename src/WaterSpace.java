...
public class WaterSpace extends JPanel
{
	...
	private class MouseHandler extends MouseAdapter
	{
		public void mousePressed(MouseEvent event)
		{
			...
			String string[] = {"Add Fish", "Add Turtle", "Remove one", "Remove all", "Stop/Start one", "Stop/Start all"};//String for button function
			if(function != 0)
			Aquarium.states.setText("Function selected: " +  string[function - 1] +  "\nNumber of Fish: " + fishcount +  "\nNumber of Turtle：" +  Torcount);//set state
		}//end mousePress
	}//end mousehandler
}
