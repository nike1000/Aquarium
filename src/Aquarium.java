...
{
	private JButton createFish = new JButton("Add Fish");
	private JButton createTor = new JButton("Add Turtle");
	private JButton removeSelect = new JButton("Remove one");
	private JButton removeAll = new JButton("Remove all");
	private JButton stopSelect = new JButton("Stop/Start one");
	private JButton stopAll = new JButton("Stop/Start all");
	public static boolean stop = true;  
	
	public static JTextArea states = new JTextArea("Function selected: \nNumber of Fish: 0\nNumber of Turtle: 0",3,10);
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		states.setText("Function selected: " + event.getActionCommand() + "\nNumber of Fish: " + space.fishcount + "\nNumber of Turtle: " + space.Torcount);
	}//end actionPerformed
}//end class
